	  ...
	  <div class="container" id="container">
		<div class="form-container sign-in">
		  <form>
			...
			<span>Entrez votre email et votre mot de passe pour vous connecter</span>
			<input v-model="user.email" type="email" placeholder="Email" />
			<input v-model="user.password" type="password" placeholder="Password" />
			<button @click="signIn" type="button">Connecter</button>
            <div class="pt-3"><span>Vous n'avez pas de compte ?</span>  <a href="/Register" class="font-semibold">Register</a> </div>
		  </form>
		</div>
